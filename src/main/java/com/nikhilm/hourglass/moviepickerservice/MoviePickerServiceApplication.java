package com.nikhilm.hourglass.moviepickerservice;
...
public class MoviePickerServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(MoviePickerServiceApplication.class, args);
	}
